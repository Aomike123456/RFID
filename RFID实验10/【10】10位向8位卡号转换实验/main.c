...
/************************用户自定义数据区域***********************/
u8 table1[]="10b:            ";//LCD1602显示10位卡号
u8 table2[]="08b:            ";//LCD1602显示8位卡号
...
void main(void)
{
  ...
  LCD1602_DIS();  				//显示字符效果
	while(1)
	{
		...
		{
			//显示10位卡号
			LCD1602_DIS_CHAR(1,5,SN/1000000000+0x30);
			LCD1602_DIS_CHAR(1,6,SN%1000000000/100000000+0x30);
			LCD1602_DIS_CHAR(1,7,SN%100000000/10000000+0x30);
			LCD1602_DIS_CHAR(1,8,SN%10000000/1000000+0x30);
			LCD1602_DIS_CHAR(1,9,SN%1000000/100000+0x30);
			LCD1602_DIS_CHAR(1,10,SN%100000/10000+0x30);
			LCD1602_DIS_CHAR(1,11,SN%10000/1000+0x30);
			LCD1602_DIS_CHAR(1,12,SN%1000/100+0x30);
			LCD1602_DIS_CHAR(1,13,SN%100/10+0x30);
			LCD1602_DIS_CHAR(1,14,SN%10+0x30);
			//显示8位卡号
			/*转换方法：10位卡号转换为十六进制数是4个字节, 第一个字节舍弃,
			第二个字节转换为8位卡号的前3位，第三个和第四个字节一起转换为8
			位卡号的后5位即可。例如：某卡片的十位卡号0319631142对应的十六
			进制形式为130D2F26，先把第一个字节“13”舍弃，把第二个字节“0D”转
			换为十进制就是13，第三个和第四个字节“2F26”转换为十进制就是12070，
			所以该卡片的8位形式就是13，12070。*/
			a=(SN/16/16/16/16/16%16)*16+(SN/16/16/16/16%16);
			LCD1602_DIS_CHAR(2,5,a/100+0x30);
			LCD1602_DIS_CHAR(2,6,a%100/10+0x30);
			LCD1602_DIS_CHAR(2,7,a%10+0x30);
			LCD1602_DIS_CHAR(2,8,',');
			b=(SN/16/16/16%16)*4096+(SN/16/16%16)*256+(SN/16%16)*16+(SN%16);
			LCD1602_DIS_CHAR(2,9,b/10000+0x30);
			LCD1602_DIS_CHAR(2,10,b%10000/1000+0x30);
			LCD1602_DIS_CHAR(2,11,b%1000/100+0x30);
			LCD1602_DIS_CHAR(2,12,b%100/10+0x30);
			LCD1602_DIS_CHAR(2,13,b%10+0x30);
		}
	}
}
/****************************************************************/
